		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<div class="container-fluid">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" data-target="action"
						id="action-link" href="#">Action</a></li>
					<li class="nav-item"><a class="nav-link" data-target="comedy"
						id="comedy-link" href="#">Comedy</a></li>
					<li class="nav-item"><a class="nav-link" data-target="romance"
						id="romance-link" href="#">Romance</a></li>
					<li class="nav-item"><a class="nav-link" data-target="fantasy"
						id="fantasy-link" href="#">Fantasy</a></li>
					<li class="nav-item"><a class="nav-link"
						data-target="thriller" id="thriller-link" href="#">Thriller</a>
				</ul>
	</header>
...
<c:forEach items="${articleList}" var="art">
				<div class="col ${art.genre} mb-5" >
					<div class="card h-100" onclick = "location.href = 'detail?boardnum=${art.boardnum}'">
						<img class="card-img-top" src="${path }/upload/${art.image}" alt="..." />
						<div class="card-body p-4">
							<div class="text-center">
								<h5 class="fw-bolder"> ${art.title }</h5>
							</div>
						</div>
					</div>
					</div>
