...
<body>
 ...
 <div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0;" id="rightMenu">
  ...
  <section>
    <h1 id='title' class="mb-5">Sign <span style="color:rgba(10, 13, 219, 0.842);">Up</span></h1>
    <div id="image_container"><img class="img-fluid" src="${path}/resource/image/singupteddy.jpg" alt="..." /></div>
    <div id="form_container" class="p-4">
      <div class="h-100 p-5">
        <!-- <form method="POST" id="loginForm" action="/auth/signUp">  db없음-->
        <form id="loginForm" action="sign-up" method="post">
          ...
          <input type="password" class="form-control mb-3" id="chkpassword" name="chkpassword" placeholder="Password check">
          ...
          <button id="signin" type="button" class="btn btn-outline-danger mb-3" style="float:center; width:100%">Sign
            in</button>
        </form>
      </div>
    </div>
...
<script>
 $('#loginForm').submit(function(){
  ...
  $(document).ready(function () {
    $("#signin").click(function () { $(location).attr("href", "sign-in") })
  })
